...
antennas = [
    # VHF (30 MHz - 300 MHz)
    {"name": "FAKE VHF Yagi Antenna", "frequency_range": (30e6, 300e6), "gain": 7, "type": "Yagi-Uda"},

    # UHF (300 MHz - 1 GHz)
    {"name": "FAKE UHF Log-Periodic Dipole Array", "frequency_range": (300e6, 1e9), "gain": 10, "type": "Log-Periodic"},
    {"name": "FAKE UHF Patch Antenna", "frequency_range": (300e6, 1e9), "gain": 8, "type": "Patch"},

    # L-Band (1 GHz - 2 GHz)
    {"name": "FAKE L-Band Helical Antenna", "frequency_range": (1e9, 2e9), "gain": 12, "type": "Helical"},
    {"name": "FALCCON - RW", "frequency_range": (1e9, 2e9), "gain": 21, "type": "Dipole Array"},
    {"name": "L Band Patch Antenna - Printech", "frequency_range": (1.563e9, 1.587e9), "gain": 5, "type": "Patch"},

    # S-Band (2 GHz - 4 GHz)
    {"name": "AC-2000 - AAC", "frequency_range": (2e9, 2.3e9), "gain": 5.2, "type": "Parabolic Dish"},
    {"name": "SANT S-band Patch Antenna - AAC", "frequency_range": (2.2e9, 2.29e9), "gain": 6, "type": "Patch", "connector": "SMP"},
    {"name": "Quad S Band Antenna - IQ Tech", "frequency_range": (1.98e9, 2.5e9), "gain": 11, "type": "Patch Array"},
    {"name": "S-Band Antenna Commercial - Enduro", "frequency_range": (2.025e9, 2.11e9), "gain": 7, "type": "Patch array"},
    {"name": "S-Band Antenna Wideband - Enduro", "frequency_range": (2.2e9, 2.29e9), "gain": 5, "type": "Patch array"},
    
    # C-Band (4 GHz - 8 GHz)
    {"name": "FAKE C-Band Horn Antenna", "frequency_range": (4e9, 8e9), "gain": 18, "type": "Horn"},

    # X-Band (8 GHz - 12 GHz)
    {"name": "X-Band Patch Antenna - Enduro", "frequency_range": (8.025e9, 8.4e9), "gain": 6, "type": "Patch"},
    {"name": "4x4 X-Band Patch Array - Enduro", "frequency_range": (8.025e9, 8.4e9), "gain": 16, "type": "Patch Array"},
    {"name": "XANT X-Band Patch Antenna - Cubecom", "frequency_range": (8e9, 8.4e9), "gain": 8, "type": "Patch"},
    {"name": "XPLANT X-band Payload Antenna - Cubecom", "frequency_range": (8.5e9, 9.6e9), "gain": 8, "type": "Patch Array"},
    {"name": "High Gain X-Band Antenna - Anywaves", "frequency_range": (7.9e9, 8.5e9), "gain": 15.5, "type": "Patch array"},
    {"name": "High-Gain X-Band Patch Array - Printech", "frequency_range": (8e9, 8.5e9), "gain": 20.7, "type": "Patch array"},
    {"name": "Lens Horn Antenna - Anteral", "frequency_range": (8.2e9, 12.4e9), "gain": 30.4, "type": "Lens Horn"}, #not trusted? 

    # Ku-Band (12 GHz - 18 GHz)
    {"name": "FAKE Ku-Band Microstrip Antenna", "frequency_range": (12e9, 18e9), "gain": 23, "type": "Microstrip"},

    # K-Band (18 GHz - 27 GHz)
    {"name": "FAKE K-Band Waveguide Antenna", "frequency_range": (18e9, 27e9), "gain": 25, "type": "Waveguide"},
    {"name": "K-Band 4x4 Patch Array - Enduro", "frequency_range": (17.7e9, 20.2e9), "gain": 16, "type": "Waveguide"},

    # Ka-Band (27 GHz - 40 GHz)
    {"name": "FAKE Ka-Band Horn Antenna", "frequency_range": (27e9, 40e9), "gain": 30, "type": "Horn"},
    {"name": "PAN-5151-64-KA - ReliaSat", "frequency_range": (27e9, 31e9), "gain": 20, "type": "Panel Array"},
    {"name": "4x4 X-Band Patch Array - Enduro", "frequency_range": (8.025e9, 8.4e9), "gain": 16, "type": "Patch Array"},

    # Above 40 GHz (EHF - Millimeter Wave Frequencies)
    {"name": "FAKE EHF Lens Antenna", "frequency_range": (40e9, 60e9), "gain": 35, "type": "Lens"},
    {"name": "FAKE Terahertz Horn Antenna", "frequency_range": (60e9, 100e9), "gain": 40, "type": "Horn"},
]
