...
antennas = [
    ...
    {"name": "SANT S-band Patch Antenna - AAC", "frequency_range": (2.2e9, 2.29e9), "gain": 6, "type": "Parabolic"},
    ...
    {"name": "XPLANT X-band Payload Antenna", "frequency_range": (8.5e9, 9.6e9), "gain": 8, "type": "Patch Array"},
    ...
    {"name": "Lens Horn Antenna - Anteral", "frequency_range": (8.2e9, 12.4e9), "gain": 30.4, "type": "Parabolic Dish"}, #not trusted? 
