...
def calculate_link_budget(orbital_params, ground_station, ground_station_receive_gain_key, satellite_params, uplink_device, satellite_transmitter, modulation_bits_per_symbol, satellite_tx_antenna, satellite_rx_antenna, desired_data_rate_uplink_bps, desired_data_rate_downlink_bps):
    """
    ...
    for modulation in satellite_transmitter["modulations"]:
        ...
        max_device_data_rate_bps = satellite_transmitter["data_rate"] * 1e3
        max_symbol_rate_device = max_device_data_rate_bps / bits_per_symbol
...
try:
    ...
    T_system = float(input("Satellite System Noise Temperature (in Kelvin, e.g., 290): "))
except ValueError:
